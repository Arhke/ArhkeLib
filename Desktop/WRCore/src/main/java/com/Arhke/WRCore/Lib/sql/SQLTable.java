...
//
//import com.Arhke.WRCore.Lib.sql.async.AsyncSQLThread;
//import com.Arhke.WRCore.Lib.sql.async.SQLAsync;
//import com.Arhke.WRCore.Lib.sql.async.SQLWait;
...
//		SQLCount.count();
//		SQLWait id = new SQLWait(SQLFunction.SET);
//		try {
//			String valueCount = "";
//			for (int i = 0; i < values.length; i++) {
//				valueCount = valueCount + "?";
...
//		SQLCount.count();
//		SQLWait id = new SQLWait(SQLFunction.GET);
//		try {
//			PreparedStatement ps = this.database.getConnection().prepareStatement("SELECT * FROM "
//					+ this.table.getName() + " WHERE " + index + "=?;");
//			ps.setObject(1, value);
...
//			throws SQLException {
//		SQLCount.count();
//		SQLWait id = new SQLWait(SQLFunction.CONTAINS);
//		try {
//			PreparedStatement ps = this.database.getConnection().prepareStatement("SELECT * FROM "
//					+ this.table.getName() + " WHERE " + index + "=?;");
//			ps.setObject(1, value);
...
//		SQLCount.count();
//		SQLWait id = new SQLWait(SQLFunction.UPDATE);
//		try {
//			PreparedStatement ps = this.database.getConnection().prepareStatement("UPDATE "
//					+ this.table.getName() + " SET " + toUpdate + "=? WHERE "
//					+ index + "=?;");
...
//		SQLWait id = new SQLWait(SQLFunction.REMOVE);
//		SQLCount.count();
//		try {
...
//		SQLWait id = new SQLWait(SQLFunction.EXECUTE_QUERY);
...
//		SQLWait id = new SQLWait(SQLFunction.EXECUTE_UPDATE);
