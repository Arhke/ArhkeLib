...
public class 	Utils {
	...
	public static boolean inSameTownOrKingdom(@Nullable TUser u1, @Nullable TUser u2){
		if(u1 == null || u2 == null || u1.getKingdom() == null || u2.getKingdom() == null){
			return false;
		}
		return u1.getKingdom().equals(u2.getKingdom());
