...
import com.Arhke.WRCore.District.Commands.CustomCommand;
 ...
 *
 */
public abstract class SubCommandsBase extends MainBase {
	protected DataManager dm;
	protected String commandName;
	public static final String ArgKey = "arg";
	public SubCommandsBase(Main instance, String commandName, DataManager dm){
		super(instance);
