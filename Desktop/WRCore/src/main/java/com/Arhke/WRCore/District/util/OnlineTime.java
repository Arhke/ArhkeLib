...
/**
 * Manage the display of /f online and /f kingdom online.
 * This class has no needed api methods.
...
public class OnlineTime {
	...
	public OnlineTime() {}
	public OnlineTime(DataManager dm){
		for(int i = 1; i <= 24; i++){
			this.setHour(i, dm.getInt(Integer.toString(i)));
		}
	}
	...
	public void write(DataManager dm){
		for (int i = 0; i < hours.length;i++){
			dm.set(hours[i], Integer.toString(i+1));
		}
