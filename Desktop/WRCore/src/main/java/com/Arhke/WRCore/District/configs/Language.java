package com.Arhke.WRCore.District.configs;
 ...
 *
 */
public class Language extends MainBase {
	public Language(Main instance){
		super(instance);
	}
...
//		return load;
//	}
	public static final String CommandKey = "commands", KingdomCommandKey = "kingdomCommand";
	private void createLanguageDefaults() {
		FileConfiguration c = Feudal.getLanguage().getConfig();
		DataManager dm = null;
		DataManager command = dm.getDataManager(CommandKey);
		DataManager kingdomCommand = dm.getDataManager(KingdomCommandKey);
		...
		c.set("reputation.placeChallenge", "Placed Battle");
		c.set("reputation.acceptChallenge", "Accepting Battle");
		...
		c.set("a.3", "&6Short Tutorial Video: &7{0}");
		c.set("a.4", "&6Full Tutorial Video: &7{0}");
		...
		c.set("commands.158", "&6&l--<&4&l{0}&6&l>--");
		c.set("commands.160", "&6Profession: &7{0}");
		c.set("commands.162", "&6Strength: &7{0} / {1} - {2}XP (DMG:{3}x, HASTE:{4})");
		c.set("commands.164", "&6Toughness: &7{0} / {1} - {2}XP (REGEN:{3}x, HP:{4})");
		c.set("commands.165", "&6Speed: &7{0} / {1} - {2}XP (SPEED:{3})");
		c.set("commands.166", "&6Stamina: &7{0} / {1} - {2}XP (STAMINA:{3})");
		c.set("commands.167", "&6Luck: &7{0} / {1} - {2}XP (CHANCE:{3}%)");
		c.set("commands.attOverall", "&6Attributes: &7{0} / {1}");
		c.set("commands.170", "&6Kingdom: &7: {0}");
		c.set("commands.172", "&6Kingdom: &7NONE");
		c.set("commands.174", "&6Reputation: &7{0}");
		c.set("commands.175", "&6Online last: &7{0}");
		c.set("commands.185", "&6Previous Professions: &7{0}");
		c.set("commands.197", "&6&l--<&4&l{0}&6&l>--");
		c.set("commands.199", "&6Profession: &7{0}");
		c.set("commands.201", "&6Strength: &7{0} / {1} - {2}XP (DMG:{3}x, HASTE:{4})");
		c.set("commands.203", "&6Toughness: &7{0} / {1} - {2}XP (REGEN:{3}x, HP:{4})");
		c.set("commands.204", "&6Speed: &7{0} / {1} - {2}XP (SPEED:{3})");
		c.set("commands.205", "&6Stamina: &7{0} / {1} - {2}XP (STAMINA:{3})");
		c.set("commands.206", "&6Luck: &7{0} / {1} - {2}XP (CHANCE:{3}%)");
		c.set("commands.209", "&6Kingdom: &7: {0}");
		c.set("commands.211", "&6Kingdom: &7NONE");
		c.set("commands.213", "&6Reputation: &7{0}");
		c.set("commands.214", "&6Online last: &7{0}");
		c.set("commands.224", "&6Previous Professions: &7{0}");
		c.set("commands.246", "&6&l--<&4&l{0}'s Speed&6&l>--");
		c.set("commands.247", "&6Speed level: &7{0} / {1}");
		c.set("commands.248", "&6XP Needed: &7{0}");
		c.set("commands.249", "&6Speed: &7{0}");
		c.set("commands.251", "&cFailed to load user data for user: {0}");
		c.set("commands.257", "&6&l--<&4&lYour Speed&6&l>--");
		c.set("commands.258", "&6Speed level: &7{0} / {1}");
		c.set("commands.259", "&6XP Needed: &7{0}");
		c.set("commands.260", "&6Speed: &7{0}");
		c.set("commands.278", "&6&l--<&4&l{0}'s Strength&6&l>--");
		c.set("commands.279", "&6Strength level: &7{0} / {1}");
		c.set("commands.280", "&6XP Needed: &7{0}");
		c.set("commands.281", "&6Damage: &7{0}x");
		c.set("commands.282", "&6Haste: &7{0}");
		c.set("commands.284", "&cFailed to load user data for user: {0}");
		c.set("commands.290", "&6&l--<&4&lYour Strength&6&l>--");
		c.set("commands.291", "&6Strength level: &7{0} / {1}");
		c.set("commands.292", "&6XP Needed: &7{0}");
		c.set("commands.293", "&6Damage: &7{0}x");
		c.set("commands.294", "&6Haste: &7{0}");
		c.set("commands.312", "&6&l--<&4&l{0}'s Toughness&6&l>--");
		c.set("commands.313", "&6Toughness level: &7{0} / {1}");
		c.set("commands.314", "&6XP Needed: &7{0}");
		c.set("commands.315", "&6Regen: &7{0}x");
		c.set("commands.316", "&6Health: &7{0}");
		c.set("commands.318", "&cFailed to load user data for user: {0}");
		c.set("commands.324", "&6&l--<&4&lYour Toughness&6&l>--");
		c.set("commands.325", "&6Toughness level: &7{0} / {1}");
		c.set("commands.326", "&6XP Needed: &7{0}");
		c.set("commands.327", "&6Regen: &7{0}x");
		c.set("commands.328", "&6Health: &7{0}");
		c.set("commands.346", "&6&l--<&4&l{0}'s Stamina&6&l>--");
		c.set("commands.347", "&6Stamina level: &7{0} / {1}");
		c.set("commands.348", "&6XP Needed: &7{0}");
		c.set("commands.349", "&6Stamina: &7{0}");
		c.set("commands.351", "&cFailed to load user data for user: {0}");
		c.set("commands.357", "&6&l--<&4&lYour Stamina&6&l>--");
		c.set("commands.358", "&6Stamina level: &7{0} / {1}");
		c.set("commands.359", "&6XP Needed: &7{0}");
		c.set("commands.360", "&6Stamina: &7{0}");
		c.set("commands.378", "&6&l--<&4&l{0}'s Luck&6&l>--");
		c.set("commands.379", "&6Luck level: &7{0} / {1}");
		c.set("commands.380", "&6XP Needed: &7{0}");
		c.set("commands.381", "&6Chance: &7{0}%");
		c.set("commands.383", "&cFailed to load user data for user: {0}");
		c.set("commands.389", "&6&l--<&4&lYour Luck&6&l>--");
		c.set("commands.390", "&6Luck level: &7{0} / {1}");
		c.set("commands.391", "&6XP Needed: &7{0}");
		c.set("commands.392", "&6Chance: &7{0}%");
		c.set("commands.410", "&6&l--<&4&l{0}'s Profession&6&l>--");
		c.set("commands.411", "&6Profession: &7{0}");
		c.set("commands.412", "&6Profession Level: &7{0} / {1}");
		c.set("commands.413", "&6XP Needed: &7{0}");
		c.set("commands.422", "&6Previous Professions: &7{0}");
		c.set("commands.425", "&cFailed to load user data for user: {0}");
		c.set("commands.431", "&6&l--<&4&lYour Profession&6&l>--");
		c.set("commands.432", "&6Profession: &7{0}");
		c.set("commands.433", "&6Profession Level: &7{0} / {1}");
		c.set("commands.434", "&6XP Needed: &7{0}");
		c.set("commands.443", "&6Previous Professions: &7{0}");
		c.set("commands.465", "&4&l--[&6&l{0}&4&l]--");
		c.set("commands.466", "&6Current time: &7{0}");
		c.set("commands.467", "&6Online last: &7{0}");
		c.set("commands.470", "&6Online percent: &7{0}%");
		c.set("commands.474", "{0}");
		c.set("commands.477", "&cFailed to load user data for user: {0}");
		c.set("commands.481", "&cUsage: &7/f online <player>");
		c.set("commands.498", "&cFailed to load user data for user: {0}");
		c.set("commands.502", "&cYou can not change another player's profession.");
		c.set("commands.522", "&cThe level must be an integer.");
		c.set("commands.534", "&cFailed to load user data for user: {0}");
		c.set("commands.548", "&cProfession level must be greater than or equal to 0.");
		c.set("commands.550", "&cProfession level exceeds max level of {0}");
		c.set("commands.554", "&aSet \"&e{0}&a\"'s profession level to {1}.");
		c.set("commands.557", "&cNULL profession data for user: {0}");
		c.set("commands.560", "&cUsage: /f setProfessionLevel <level> [player]");
		c.set("commands.572", "&cThe level must be an integer.");
		c.set("commands.584", "&cFailed to load user data for user: {0}");
		c.set("commands.598", "&cSpeed level must be greater than or equal to 0.");
		c.set("commands.600", "&cSpeed level exceeds max level of {0}");
		c.set("commands.605", "&aSet \"&e{0}&a\"'s speed level to {1}.");
		c.set("commands.608", "&cNULL speed data for user: {0}");
		c.set("commands.611", "&cUsage: /f setSpeedLevel <level> [player]");
		c.set("commands.623", "&cThe level must be an integer.");
		c.set("commands.635", "&cFailed to load user data for user: {0}");
		c.set("commands.649", "&cStrength level must be greater than or equal to 0.");
		c.set("commands.651", "&cStrength level exceeds max level of {0}");
		c.set("commands.656", "&aSet \"&e{0}&a\"'s strength level to {1}.");
		c.set("commands.659", "&cNULL strength data for user: {0}");
		c.set("commands.662", "&cUsage: /f setStrengthLevel <level> [player]");
		c.set("commands.674", "&cThe level must be an integer.");
		c.set("commands.686", "&cFailed to load user data for user: {0}");
		c.set("commands.700", "&cToughness level must be greater than or equal to 0.");
		c.set("commands.702", "&cToughness level exceeds max level of {0}");
		c.set("commands.707", "&aSet \"&e{0}&a\"'s toughness level to {1}.");
		c.set("commands.710", "&cNULL toughness data for user: {0}");
		c.set("commands.713", "&cUsage: /f setToughnessLevel <level> [player]");
		c.set("commands.725", "&cThe level must be an integer.");
		c.set("commands.737", "&cFailed to load user data for user: {0}");
		c.set("commands.751", "&cStamina level must be greater than or equal to 0.");
		c.set("commands.753", "&cStamina level exceeds max level of {0}");
		c.set("commands.758", "&aSet \"&e{0}&a\"'s stamina level to {1}.");
		c.set("commands.761", "&cNULL stamina data for user: {0}");
		c.set("commands.764", "&cUsage: /f setStaminaLevel <level> [player]");
		c.set("commands.776", "&cThe level must be an integer.");
		c.set("commands.788", "&cFailed to load user data for user: {0}");
		c.set("commands.802", "&cLuck level must be greater than or equal to 0.");
		c.set("commands.804", "&cLuck level exceeds max level of {0}");
		c.set("commands.809", "&aSet \"&e{0}&a\"'s luck level to {1}.");
		c.set("commands.812", "&cNULL luck data for user: {0}");
		c.set("commands.815", "&cUsage: /f setLuckLevel <level> [player]");
		c.set("commands.852", "&aReset: {0}");
		c.set("commands.854", "&cFailed to load user data for user: {0}");
		c.set("commands.858", "&cYou must enter a player to be reset.");
		c.set("commands.867", "&cA kingdom name must be at least &6{0}&c characters long.");
		c.set("commands.871", "&cA kingdom name's length must be less than or equal to &6{0}&c characters.");
		c.set("commands.875", "&cThat name is not allowed.");
		c.set("commands.883", "&cThe name &6{0}&c is banned on this server.");
		...
		c.set("commands.1011", "&aKingdom joined: &7{0}");
		...
		c.set("commands.1037", "&c{0} is currently in a kingdom.");
		c.set("commands.1046", "&a{0} invited you to join his kingdom: &e{1}");
		c.set("commands.1050", "&a{0} has been invited to your kingdom.");
		c.set("commands.1052", "&e{0} has been invited to your kingdom.  &cThey did not receive a notification because they are not online.");
		c.set("commands.1056", "&cThat user has already been invited to your kingdom. &6{0} has been removed from the invite list.");
		...
		c.set("commands.1111", "&aKingdom open: &7{0}");
		...
		c.set("commands.1232", "&a{0} has been set to the new leader.");
		...
		c.set("commands.1289", "&aYou have left your kingdom: {0}");
		...
		c.set("commands.1576", "&5[&6{0}&5] &cYou have been kicked from your kingdom by {1}");
		...
		c.set("commands.1668", "&c{0} currently owns this land.  Battle them to take their land.{1} Land: {2}, ");
		c.set("commands.1680", "&cLand: &7{0}, {1} &ccan not be claimed.");
		...
		c.set("commands.1717", "&cNOTICE &e> &6Hourly land tax: &7${0}");
		c.set("commands.1726", "&eYour kingdom already owns this land: {0}, {1}");
		c.set("commands.1728", "&c{0} currently owns this land.  Battle them to take their land.");
		c.set("commands.1742", "&4Failed to save kingdom data!");
		c.set("commands.1748", "&cNOTICE &e> &6Hourly land tax: &7${0}");
		c.set("commands.1750", "&cLand: &7{0}, {1} &ccan not be claimed.");
		c.set("commands.1753", "&cYou can only claim land which is connected to other land you own.");
		c.set("commands.1757", "&cYour kingdom has reached it's maximum amount of land: {0} chunks");
		...
		c.set("commands.1812", "&6Unclaimed land: &7{0}, {1}");
		...
		c.set("commands.1860", "&6Unclaimed land: &7{0}, {1}");
		...
		c.set("commands.1915", "&eUnclaimed land: {0}, {1}");
		...
		c.set("commands.1993", "&aTeleporting in &7{0} &aseconds. Don't move.");
		...
		c.set("commands.2096", "&6Kingdom: {0}");
		c.set("commands.2098", "&6Kingdom: {0}");
		c.set("commands.2108", "{0}");
		c.set("commands.2110", "{0}");
		...
		c.set("commands.2202", "&7${0} &6added to the treasury. New treasury balance: &7${1}");
		c.set("commands.2204", "&cYou do not have enough money to add: &7${0} &cBalance: &7${1}");
		c.set("commands.2215", "&cFailed to save kingdom or user data!");
		c.set("commands.2219", "&7${0} &6removed from the treasury. New treasury balance: &7${1}");
		c.set("commands.2221", "&cThe treasury does not have enough money to remove: &7${0} &cTreasury: &7${1}");
		...
		c.set("commands.2230", "&6Kingdom treasury: &7${0}");
		...
		c.set("commands.2474", "&cA kingdom name must be at least &6{0}&c characters long.");
		c.set("commands.2478", "&cA kingdom name's length must be less than or equal to &6{0}&c characters.");
		c.set("commands.2482", "&cThat name is not allowed.");
		c.set("commands.2490", "&cThe name &6{0}&c is banned on this server.");
		...
		c.set("commands.2572", "&4&l�=&9&lChallenges 1/{0}&4&l=�");
		c.set("commands.2584", "&cInvalid page.");
		c.set("commands.2588", "&cThe page number must be greater than 0.");
		c.set("commands.2599", "&cThe page number can not exceed &7{0}");
		c.set("commands.2602", "&4&l-=�&9&lChallenges 1/{0}&4&l=-");
		...
		c.set("commands.2650", "&6Defence challenge with &7{0}&6 has been accepted. &7Fighting will begin when the enemy fighters are online and your fighters are online.  If they do not come online at the same time as your kingdom, then the kingdom with the most online time will win after one week.");
		...
		c.set("commands.2670", "&6Attacker: &7{0}");
		c.set("commands.2671", "&6Defender: &7{0}");
		c.set("commands.2672", "&6Location: &7{0}");
		c.set("commands.2673", "&6Accepted: &7{0}");
		c.set("commands.2675", "&6Time remaining: &7{0}");
		...
		c.set("commands.2721", "&4&l-=&6&l{0}&4&l=-");
		c.set("commands.2722", "&6Current time: &7{0}");
		c.set("commands.2724", "&6ONLINE NOW");
		c.set("commands.2726", "&6Online last: &7{0}");
		c.set("commands.2730", "{0}");
		...
		c.set("commands.2783", "&7{0} &6was forced to win their challenge with &7{1}");
		c.set("commands.2785", "&cA challenge with attacker: &7{0} &cand defender: &7{1} &ccould not be found.");
		...
		c.set("commands.2827", "&cYou can not promote that player. Use &7/f leader {0} &cto set this player as the kingdom leader.");
		c.set("commands.2834", "&cFailed to save kingdom data!");
		c.set("commands.2838", "&7{0} &6was promoted to &7{1}");
		c.set("commands.2840", "&2You have been promoted by &7{0} &6New Rank: &7{1}");
		...
		c.set("commands.2898", "&cYou can not demote that player. Use &7/f kick {0} &cto kick this player.");
		c.set("commands.2905", "&cFailed to save kingdom data!");
		c.set("commands.2909", "&7{0} &6was demoted to &7{1}");
		c.set("commands.2911", "&cYou have been demoted by &7{0} &6New Rank: &7{1}");
		...
		c.set("commands.2954", "&cThe page number must be less than or equal to &7{0}");
		c.set("commands.2960", "&9&l===[&c&lKingdom List {0}/{1}&9&l]===");
		c.set("commands.2962", "&6{0}: &7{1}/{2} online, {3}/{4}, ${5}");
		c.set("commands.2965", "&cFailed to list kingdoms.");
		c.set("commands.2971", "&9&l===[&c&lKingdom List 1/{0}&9&l]===");
		c.set("commands.2973", "&6{0}: &7{1}/{2} online, {3}/{4}, ${5}");
		c.set("commands.2976", "&cFailed to list kingdoms.");
		c.set("commands.2989", "&cInvalid number for reputation.");
		c.set("commands.2993", "&cReputation must be greater than or equal to &6{0}");
		c.set("commands.2995", "&cReputation must be less than or equal to &6{0}");
		c.set("commands.3009", "&cError saving reputation to player.");
		c.set("commands.3012", "&7{0} &6reputation set to &7{1}");
		...
		c.set("commands.3086", "&cOne week shield costs &7${0}. &cYou need ${1} &cmore.");
		...
		c.set("commands.3111", "&cTwo week shield costs &7${0}. &cYou need ${1} &cmore.");
		...
		c.set("commands.3136", "&cThree week shield costs &7${0}. &cYou need ${1} &cmore.");
		...
		c.set("commands.3151", "&6One Week Shield: &7${0} &6Cool down: &7{1} days");
		c.set("commands.3152", "&6Two Week Shield: &7${0} &6Cool down: &7{1} days");
		c.set("commands.3153", "&6Three Week Shield: &7${0} &6Cool down: &7{1} days");
		c.set("commands.3154", "&6Vacation: &7${0} &6Cool down: &7{1} days");
		c.set("commands.3155", "&2Commands: &7/shield <1/2/3/stop>, /vacation");
		c.set("commands.3157", "&aActive Shield: &7{0}");
		...
		c.set("commands.3206", "&cYou do not have enough money to do this. Money needed: &7${0}");
		...
		c.set("commands.3232", "&cReputation must be greater than or equal to &6{0}");
		c.set("commands.3234", "&cReputation must be less than or equal to &6{0}");
		c.set("commands.3238", "&cInvalid player: &7{0}");
		c.set("commands.3248", "&cError saving reputation to player.");
		c.set("commands.3251", "&7{0} &6reputation set to &7{1}");
		...
		c.set("commands.3337", "&9&l===< &6&lFeudal {0} / {1} &9&l>===");
		c.set("commands.3344", "&6&l> &2/f about &7- gives credit and information about Feudal");
		c.set("commands.2612", "&e{0} &7vs &e{1}{2}");
		c.set("commands.2612_c1", " &4&lFIGHTING");
		c.set("commands.2612_c2", " &4&lACTIVE: %time%");
		c.set("commands.2656", "{0}{4} &7vs {1}{2}{3}");
		c.set("commands.3175", "&c{0} ended by: &7{1} &c{0} disabled for &7{2}");
		c.set("commands.3175_a1", "Vacation");
		c.set("commands.3175_a2", "Shield");
		c.set("commands.3196", "&aShield Created by &7{0} &aShield &7{1}");
		c.set("commands.3321a", "&aVacation shield activated! Shield duration: &7One Week");
		c.set("commands.1019", "&a{0} has joined your kingdom.");
		c.set("commands.1314", "&e{0} has left the kingdom.");
		c.set("commands.1453", "&a{0} has requested to no longer be enemies with your kingdom. Do /f neutral {0} to accept their request.");
		c.set("commands.1543", "&a{0} has requested to be allies with your kingdom. Do /f ally {0} to accept their request.");
		c.set("commands.1612", "&c{0} was kicked from your kingdom by {1}");
		c.set("commands.kc1", "&6Kingdom chat set to: &7{1}");
		
		c.set("commands2.1020", "&a{0} has joined your kingdom.{1}");
		c.set("commands2.1315", "&e{0} left the kingdom.{1}");
		c.set("commands2.1454", "&a{1}{0} has requested to no longer be enemies with your kingdom. Do /f neutral {1}{0} to accept their request.{2}");
		c.set("commands2.1544", "&a{1}{0} has requested to be allies with your kingdom. Do /f ally {1}{0} to accept their request.{2}");
		c.set("commands2.1613", "&c{0} was kicked from your kingdom by {1}");
		c.set("commands2.1715", "&7{0}&e claimed land for your kingdom. &7({1}, {2}){3}");
		c.set("commands2.1788", "&7{0}&e claimed land for your kingdom. &7({1}, {2}){3}");
		c.set("commands2.2446", "&6Kingdom banner changed by: &7{0}");
		c.set("commands2.2465", "&6Kingdom banner changed by: &7{0}");
		c.set("commands2.2537", "&7{0} &akingdom name changed to &7{1}");
		c.set("commands2.2594", "&7{0} &akingdom name changed to &7{1}");
		c.set("commands2.3202", "&aShield Created by &7{0} &aShield &7{1}");
		c.set("commands2.3228", "&aShield Created by &7{0} &aShield &7{1}");
		c.set("commands2.3254", "&aShield Created by &7{0} &aShield &7{1}");
		
		c.set("commandHelp.18", "&6&l> {0}/f help [page] &7- list of feudal commands");
		c.set("commandHelp.20", "&6&l> {0}/f tutorial &7- gives links to videos, tutorials, and the wiki");
		c.set("commandHelp.24", "&6&l> {0}/f market &7- open the market");
		c.set("commandHelp.26", "&6&l> {0}/f sell [price] &7- sell the item in your hand");
		c.set("commandHelp.28", "&6&l> {0}/f price &7- get the price of the item(s) you are holding");
		c.set("commandHelp.new1246", "&6&l> {0}/f unenchant &7- unenchant item in hand");
		c.set("commandHelp.30", "&6&l> {0}/f c [player] &7- view character information");
		c.set("commandHelp.32", "&6&l> {0}/f cp [player] &7- change your profession");
		c.set("commandHelp.34", "&6&l> {0}/f create <kingdom> &7- create a kingdom");
		c.set("commandHelp.36", "&6&l> {0}/f join <kingdom> &7- join a kingdom");
		c.set("commandHelp.38", "&6&l> {0}/f invite <player> &7- invite a player to join your kingdom");
		c.set("commandHelp.40", "&6&l> {0}/f challenge help &7- view challenge help and information");
		c.set("commandHelp.42", "&6&l> {0}/f delete [kingdom] &7- delete your kingdom");
		c.set("commandHelp.44", "&6&l> {0}/f leader <player> &7- make a player leader of your kingdom");
		c.set("commandHelp.46", "&6&l> {0}/f leave &7- leave your kingdom");
		c.set("commandHelp.48", "&6&l> {0}/f kick <player> &7- kick a player from your kingdom");
		c.set("commandHelp.50", "&6&l> {0}/f claim [radius] &7- claim land for your kingdom");
		c.set("commandHelp.52", "&6&l> {0}/f unclaim [all] &7- unclaims your kingdom land");
		c.set("commandHelp.54", "&6&l> {0}/f setHome &7- set the home for your kingdom");
		c.set("commandHelp.56", "&6&l> {0}/f home &7- go to your kingdom's home");
		c.set("commandHelp.58", "&6&l> {0}/f view &7- lets you view what kingdoms are around you");
		c.set("commandHelp.60", "&6&l> {0}/f promote <player> &7- promote a player in your kingdom");
		c.set("commandHelp.62", "&6&l> {0}/f demote <player> &7- demote a player in your kingdom");
		c.set("commandHelp.64", "&6&l> {0}/f list [page] &7- list all the kingdoms");
		c.set("commandHelp.66", "&6&l> {0}/f treasury [add/remove] <amount> &7- view, add, or remove money from your kingdom's treasury");
		c.set("commandHelp.68", "&6&l> {0}/f info <kingdom> &7- display information about a kingdom");
		c.set("commandHelp.70", "&6&l> {0}/f d [Desc] &7- views and/or sets your kingdom Desc");
		c.set("commandHelp.72", "&6&l> {0}/f name <name> &7- change your kingdom's name");
		c.set("commandHelp.74", "&6&l> {0}/f banner &7- set the banner in your hand to your kingdom's banner");
		c.set("commandHelp.76", "&6&l> {0}/f setBanner [random] &7- sets your kingdom banner as the one you are holding and/or sets your kingdom banner as a random banner");
		c.set("commandHelp.78", "&6&l> {0}/f kc &7- Toggle kingdom chat");
		c.set("commandHelp.80", "&6&l> {0}/f challenge accept <kingdom> &7- accept a challenge from a kingdom");
		c.set("commandHelp.82", "&6&l> {0}/f challenge surrender <kingdom> &7- give up in a challenge. This lets the enemy take your land and treasury if you are the defender");
		c.set("commandHelp.84", "&6&l> {0}/f challenge info <kingdom> &7- view info for a challenge with a kingdom");
		c.set("commandHelp.86", "&6&l> {0}/f challenge tp <kingdom> &7- teleport to the fighting area for a challenge");
		c.set("commandHelp.88", "&6&l> {0}/f challenge list [page] &7- list your kingdom's current challenges");
		c.set("commandHelp.90", "&6&l> {0}/f enemy <kingdom> &7- set a kingdom as an enemy");
		c.set("commandHelp.92", "&6&l> {0}/f neutral <kingdom> &7- set a kingdom as neutral");
		c.set("commandHelp.94", "&6&l> {0}/f ally <kingdom> &7- set a kingdom as an ally");
		c.set("commandHelp.96", "&6&l> {0}/f setOpen <true/false> &7- make it possible for anyone to join your kingdom without an invite");
		c.set("commandHelp.98", "&6&l> {0}/f banInfo [kingdom] &7- list kingdoms and time remaining which you cannot challenge");
		c.set("commandHelp.100", "&6&l> {0}/f kingdomOnline <kingdom> &7- check when a kingdom is online the most");
		c.set("commandHelp.102", "&6&l> {0}/f speed [player] &7- view info on a player's speed");
		c.set("commandHelp.104", "&6&l> {0}/f strength [player] &7- view info on a player's strength");
		c.set("commandHelp.106", "&6&l> {0}/f toughness [player] &7- view info on a player's toughness");
		c.set("commandHelp.108", "&6&l> {0}/f stamina [player] &7- view info on a player's stamina");
		c.set("commandHelp.110", "&6&l> {0}/f luck [player] &7- view info on a player's luck");
		c.set("commandHelp.112", "&6&l> {0}/f p [player] &7- view information about a player's profession");
		c.set("commandHelp.114", "&6&l> {0}/f online <player> &7- check what times a player is online the most");
		c.set("commandHelp.116", "&6&l> {0}/f shield <1/2/3> &7- buy a shield for your kingdom (1, 2, or 3 weeks)");
		c.set("commandHelp.118", "&6&l> {0}/f shield stop &7- stop your current shield (no refunds)");
		c.set("commandHelp.120", "&6&l> {0}/f shield &7- view information about shields");
		c.set("commandHelp.122", "&6&l> {0}/f vacation &7- buy a vacation shield");
		c.set("commandHelp.124", "&6&l> {0}/f setProfessionLevel <level> [player] &7- set a player's profession level (ADMIN)");
		c.set("commandHelp.126", "&6&l> {0}/f setSpeedLevel <level> [player] &7- sets a player's speed level (ADMIN)");
		c.set("commandHelp.128", "&6&l> {0}/f setStrengthLevel <level> [player] &7- sets a player's strength level (ADMIN)");
		c.set("commandHelp.130", "&6&l> {0}/f setToughnessLevel <level> [player] &7- sets a player's toughness level (ADMIN)");
		c.set("commandHelp.132", "&6&l> {0}/f setStaminaLevel <level> [player] &7- sets a player's stamina level (ADMIN)");
		c.set("commandHelp.134", "&6&l> {0}/f setLuckLevel <level> [player] &7- sets a player's luck level (ADMIN)");
		c.set("commandHelp.136", "&6&l> {0}/f resetCharacter <player> &7- Resets an entire character. Delete their kingdom if they are the leader. (ADMIN)");
		c.set("commandHelp.138", "&6&l> {0}/f setReputation <player> <reputation> &7- Change a players reputation (ADMIN)");
		c.set("commandHelp.140", "&6&l> {0}/f forceWin <Kingdom> <vs> &7- Make kingdom win (ADMIN)");
		c.set("commandHelp.141", "&6&l> {0}/f findclaims &7- View claimed land");
		...
		c.set("changeProfession.change", "&aProfession changed to &c&l{0}");
		...
		c.set("newCommands.helpFighter", "&6&l> {0}/f fighter <player> &7- toggle kingdom member as a fighter");
		...
		c.set("commandHelp.141", "&6&l> {0}/f reload &7- Reload configs (ADMIN)");
		...
		c.set("kingdomlog.cmd", "&6&l> {0}/f kingdomlog <player> &7- See a player's kingdom log (ADMIN)");
		...
		c.set("spar.tooFar", "&cYou must be within {0} blocks of that player to spar them.");
		c.set("spar.sparSelf", "&cYou cannot spar yourself!");
		
		c.set("spar.commandHelp", "&6&l> {0}/f spar <player> [bet] &7- Spar a player or kingdom member.");
		
		//Redistribute
		c.set("redistribute.noUser", "&cYour character has not been setup or has failed to load.");
		c.set("redistribute.commandHelp", "&6&l> {0}/f attributes &7- Redistribute attributes");
		...
		c.set("commandHelp.460", "&6&l> {0}/f manage &7- manage kingdom with GUI");
		...
		c.set("m.setrank", "&7{0} &6was set to &7{1}");
		c.set("m.setrank2", "&2Your rank has been changed by &7{0} &6New Rank: &7{1}");
	...
	private static void updateDefaults() {
		...
		if(!c.contains("kingdomlog.noInt")){
			...
			c.set("kingdomlog.title", "&6&lKingdom logs (%name%)");
			c.set("kingdomlog.log", "&d%join% %kingdom% %time%");
			c.set("kingdomlog.cmd", "&6&l> {0}/f kingdomlog <player> [page] &7- See a player's kingdom log (ADMIN)");
			c.set("kingdomlog.noInt", "&cThe page number must be an integer.");
		}
