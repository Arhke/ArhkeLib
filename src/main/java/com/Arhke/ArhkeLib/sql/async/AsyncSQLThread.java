//package com.Arhke.ArhkeLib.sql.async;
//
...
//import com.Arhke.ArhkeLib.sql.async.SQLWait.SQLFunction;
//import com.Arhke.ArhkeLib.District.util.StackUtil;
//
...
//		if(command.getId().getFunction().equals(SQLFunction.SET)){
//			try {
...
//				}
//			}
//		}else if(command.getId().getFunction().equals(SQLFunction.UPDATE)){
//			try{
//				command.getPs().executeUpdate();
//				executeEvent(new SQLProcessEvent(command.getId(), Code.SUCCESS));
//			}catch(SQLException e){
...
//				executeEvent(new SQLProcessEvent(command.getId(), Code.FAIL));
//			}
//		}else if(command.getId().getFunction().equals(SQLFunction.GET)){
//			try {
...
//				e.printStackTrace();
//			}
//		}else if(command.getId().getFunction().equals(SQLFunction.CONTAINS)){
//			try {
//				ResultSet result = command.getPs().executeQuery();
...
//				e.printStackTrace();
//			}
//		}else if(command.getId().getFunction().equals(SQLFunction.EXECUTE_QUERY)){
//			try {
//				ResultSet set = Feudal._feudal.getSql().getSqlControler().executeQuery(command.getData(), command.isNext());
...
//				executeEvent(new SQLProcessEvent(command.getId(), Code.FAIL));
//			}
//		}else if(command.getId().getFunction().equals(SQLFunction.EXECUTE_UPDATE)){
//			try {
//				boolean didUpdate = Feudal._feudal.getSql().getSqlControler().executeUpdate(command.getData());
