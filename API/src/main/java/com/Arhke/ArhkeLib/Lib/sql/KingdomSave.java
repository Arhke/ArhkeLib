...
//import com.Arhke.ArhkeLib.District.kingdoms.Rank;
...
//			for(String pattern : kingdom.getBannerPatterns().getBannerList()) {
//				banner += pattern + "~";
//			}
//		}
//
//		final SQLControl sql = Feudal._feudal.getSql();
//
...
//				" bannerBackground='" + kingdom.getBannerBaseColor().toString() + "'," +
//				" banner='" + banner + "'" +
...
//		String landValues = "";
//		for(ChunkData land : kingdom.getLand()) {
...
//						kingdom.getBannerBaseColor().toString(),
//						banner
//						);
//
//				sql.getMembersSQL().remove("kingdom_uuid", kingdom.getUUID());
