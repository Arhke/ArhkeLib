...
//
//import com.Arhke.ArhkeLib.District.TUsers.TUser;
//import com.Arhke.ArhkeLib.ArhkeLib;
//import org.bukkit.Bukkit;
//import org.bukkit.Location;
//import org.bukkit.entity.Player;
//
//import com.Arhke.ArhkeLib.District.api.events.NewUserEvent;
//import com.Arhke.ArhkeLib.District.core.Feudal;
//import com.Arhke.ArhkeLib.District.core.ScheduledTasks;
//import com.Arhke.ArhkeLib.District.kingdoms.ChallengeManager;
//import com.Arhke.ArhkeLib.District.kingdoms.Kingdom;
//import com.Arhke.ArhkeLib.District.kingdoms.KingdomLog;
//import com.Arhke.ArhkeLib.District.TUsers.AttributeFixer;
//import com.Arhke.ArhkeLib.District.TUsers.Selection;
//import com.Arhke.ArhkeLib.District.TUsers.classes.Profession;
//import com.Arhke.ArhkeLib.District.TUsers.classes.ProfessionType;
//import com.Arhke.ArhkeLib.District.util.Base64;
...
//		}catch(Exception e) {
//			e.printStackTrace();
//			Feudal.error("Failed to get user location from sql while saving: " + user.getID() + " - " + user.getName());
//		}
//
//		user.setLastJoin();
...
//	 */
//	public static void load(TUser user) {
//		SQLControl sql = Feudal._feudal.getSql();
//
...
//									if(type.CLASS.equals(ProfessionType.PEASANT)) {
//										types.add(type);
//									}
//								}
...
//								for(Profession.Type type : Profession.Type.values()) {
//									if(type.CLASS.equals(ProfessionType.COMMONER)) {
//										types.add(type);
//									}
//								}
//								prof = types.get(rand.nextInt(types.size()));
...
//								for(Profession.Type type : Profession.Type.values()) {
//									if(type.CLASS.equals(ProfessionType.NOBLE)) {
//										types.add(type);
//									}
//								}
//								prof = types.get(rand.nextInt(types.size()));
...
//				}
//
//				final TUser finalU = u;
//				Bukkit.getScheduler().scheduleSyncDelayedTask(
//						ArhkeLib.getPlugin(), new Runnable() {
//
//							@Override
//							public void run() {
...
//	 * Returns user
//	 */
//	public static TUser getUser(String uuid) {
//		try {
//			if (Feudal._feudal.getSql().getUsersSQL().contains("uuid", uuid)) {
